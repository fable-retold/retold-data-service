...
return fCallback();}}onAfterInitialize(){if(this.pict.LogNoisiness>3){this.log.trace(`PictProvider [${this.UUID}]::[${this.Hash}] ${this.options.ProviderIdentifier} onAfterInitialize:`);}return true;}/**
	 ...
	 *
	 * @return {void}
	 */onAfterSaveDataAsync(fCallback){return fCallback();}}module.exports=PictProvider;},{"../package.json":11,"fable-serviceproviderbase":2}],13:[function(require,module,exports){/**
...
SchemasAddress:'AppData.Connection.Schemas',ActiveAddress:'AppData.Connection.ActiveProvider',FieldIDPrefix:'pict-conn',ShowProviderSelect:true,ShowAdvancedToggle:true};},{}],14:[function(require,module,exports){/**
...
function padLeft(pStr,pLen){let tmpStr=String(pStr);while(tmpStr.length<pLen){tmpStr=' '+tmpStr;}return tmpStr;}function padRight(pStr,pLen){let tmpStr=String(pStr);while(tmpStr.length<pLen){tmpStr=tmpStr+' ';}return tmpStr;}function padCenter(pStr,pLen){let tmpStr=String(pStr);while(tmpStr.length<pLen){tmpStr=tmpStr.length%2===0?tmpStr+' ':' '+tmpStr;}return tmpStr;}module.exports={render,wireEvents,renderVertical,renderHorizontal};},{}],20:[function(require,module,exports){/**
 * Pict-Modal-Confirm
 *
...
fResolve(pResult);}/**
	 ...
	 * @param {string} pText
	 * @returns {string}
	 */_escapeHTML(pText){if(typeof pText!=='string'){return'';}return pText.replace(/&/g,'&amp;').replace(/</g,'&lt;').replace(/>/g,'&gt;').replace(/"/g,'&quot;');}}module.exports=PictModalConfirm;},{}],21:[function(require,module,exports){/**
 * Pict-Modal-Dropdown
 *
...
setTimeout(()=>{if(tmpElement.parentNode){tmpElement.parentNode.removeChild(tmpElement);}},220);this._element=null;this._currentClickHandler=null;}}}/**
	 ...
	 */destroy(){this._refCount=0;if(this._element&&this._element.parentNode){this._element.parentNode.removeChild(this._element);}this._element=null;this._currentClickHandler=null;}}module.exports=PictModalOverlay;},{}],23:[function(require,module,exports){/**
 * Pict-Modal-Panel
 *
...
let tmpHandle={id:tmpId,collapse:tmpCollapse,expand:tmpExpand,toggle:tmpToggle,setWidth:tmpSetWidth,destroy:tmpDestroy};this._panels.push(tmpHandle);return tmpHandle;}/**
	 ...
	 */destroyAll(){let tmpPanels=this._panels.slice();for(let i=0;i<tmpPanels.length;i++){tmpPanels[i].destroy();}}}module.exports=PictModalPanel;},{}],24:[function(require,module,exports){/**
...
if(tmpOptions.duration>0){tmpTimeoutHandle=setTimeout(tmpDismiss,tmpOptions.duration);}return tmpHandle;}/**
	 ...
	 * @param {string} pText
	 * @returns {string}
	 */_escapeHTML(pText){if(typeof pText!=='string'){return'';}return pText.replace(/&/g,'&amp;').replace(/</g,'&lt;').replace(/>/g,'&gt;').replace(/"/g,'&quot;');}}module.exports=PictModalToast;},{}],26:[function(require,module,exports){/**
 * Pict-Modal-Tooltip
 *
...
/**
	 ...
	 *//**
	 * Destroy all active panels.
	 */destroyPanels(){this._panel.destroyAll();}destroy(){this.dismissAll();this.destroyPanels();this._overlay.destroy();this._toast.destroy();if(typeof super.destroy==='function'){return super.destroy();}}}module.exports=PictSectionModal;module.exports.default_configuration=_DefaultConfiguration;},{"./Pict-Modal-Confirm.js":20,"./Pict-Modal-Dropdown.js":21,"./Pict-Modal-Overlay.js":22,"./Pict-Modal-Panel.js":23,"./Pict-Modal-Shell.js":24,"./Pict-Modal-Toast.js":25,"./Pict-Modal-Tooltip.js":26,"./Pict-Modal-Window.js":27,"./Pict-Section-Modal-DefaultConfiguration.js":28,"pict-view":91}],30:[function(require,module,exports){/**
...
module.exports.registerCatalog=registerCatalog;module.exports.listCatalog=listCatalog;module.exports.install=install;module.exports.clearPersistence=clearPersistence;},{"./Theme-Brand.js":31,"./Theme-Persistence.js":33,"./Theme-Scale.js":34,"./themes/_catalog.js":38,"./views/PictView-Theme-BottomBar.js":80,"./views/PictView-Theme-Brand-Mark.js":81,"./views/PictView-Theme-BrandStrip.js":82,"./views/PictView-Theme-Button.js":83,"./views/PictView-Theme-ModeToggle.js":84,"./views/PictView-Theme-Picker.js":85,"./views/PictView-Theme-ScaleSelect.js":86,"./views/PictView-Theme-TopBar.js":87,"pict-provider":12,"pict-provider-theme":5}],31:[function(require,module,exports){/**
...
if(tmpIsRootRenderable&&pRenderable&&pRenderable.TransactionHash){this.pict.TransactionTracking.unregisterTransaction(pRenderable.TransactionHash);}return fCallback(pError);});}/**
	 ...
	 *
	 * @param {ErrorCallback} fCallback - The callback to call when the async operation is complete.
	 */onAfterMarshalToViewAsync(fCallback){this.onAfterMarshalToView();return fCallback();}/** @return {boolean} - True if the object is a PictView. */get isPictView(){return true;}}module.exports=PictView;},{"../package.json":90,"fable-serviceproviderbase":2}],92:[function(require,module,exports){// shim for using process in browser
...
this.pict.views['DataCloner-StatusBar'].render();this.pict.providers.DataCloner.initPersistence();this.pict.providers.DataCloner.restoreDeployedTables();this.pict.providers.DataCloner.startLiveStatusPolling();this.pict.providers.DataCloner.initAccordionPreviews();this.pict.providers.DataCloner.updateAllPreviews();this.pict.views['DataCloner-Layout'].collapseAllSections();this.pict.providers.DataCloner.initAutoProcess();this.pict.providers.DataCloner.bootstrapConnectionSchemas(function(){/* fire-and-forget */});return fCallback();}}module.exports=DataClonerApplication;module.exports.default_configuration=require('./Pict-Application-DataCloner-Configuration.json');},{"../../RetoldDataService-Brand.js":94,"./Pict-Application-DataCloner-Configuration.json":95,"./providers/Pict-Provider-DataCloner.js":98,"./views/PictView-DataCloner-Connection.js":99,"./views/PictView-DataCloner-Deploy.js":100,"./views/PictView-DataCloner-Export.js":101,"./views/PictView-DataCloner-Layout.js":102,"./views/PictView-DataCloner-Schema.js":103,"./views/PictView-DataCloner-Session.js":104,"./views/PictView-DataCloner-SettingsPanel.js":105,"./views/PictView-DataCloner-Shell.js":106,"./views/PictView-DataCloner-StatusBar.js":107,"./views/PictView-DataCloner-StatusDetail.js":108,"./views/PictView-DataCloner-Sync.js":109,"./views/PictView-DataCloner-TopBar-Nav.js":110,"./views/PictView-DataCloner-TopBar-User.js":111,"./views/PictView-DataCloner-ViewData.js":112,"pict-application":4,"pict-section-connection-form":14,"pict-section-histogram":16,"pict-section-modal":29,"pict-section-theme":30}],97:[function(require,module,exports){module.exports={DataClonerApplication:require('./Pict-Application-DataCloner.js')};if(typeof window!=='undefined'){window.DataClonerApplication=module.exports.DataClonerApplication;}},{"./Pict-Application-DataCloner.js":96}],98:[function(require,module,exports){const libPictProvider=require('pict-provider');class DataClonerProvider extends libPictProvider{constructor(pFable,pOptions,pServiceHash){super(pFable,pOptions,pServiceHash);}// ================================================================
// API Helper
// ================================================================
...
`}],Renderables:[{RenderableHash:'DataCloner-ViewData',TemplateHash:'DataCloner-ViewData',DestinationAddress:'#DataCloner-Section-ViewData'}]};},{"pict-view":91}]},{},[97])(97);});
